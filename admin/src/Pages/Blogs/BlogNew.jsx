...
const BlogNew = () => {
  ...
  const handleSubmit = (e) => {
    ...
    postData("/api/blog/create", formFeilds, {
      withCredentials: true,
    }).then((res) => {
      console.log(res);
      if (res?.error !== true) {
        context.openAlertBox("success", res?.message, "createBlog-success");
        setFormFeilds({
          name: "",
          images: [],
        });
        ...
        context.openAlertBox("error", res?.message, "createBlog-error");
        setIsLoading(false);
      }
    });
  };
        ...
        >
          <div className="shadow-md rounded-md p-3 bg-white mt-5">
            <div className="cartHead p-2 pb-4 mb-3 border-b border-[#ff5252]">
              <h2 className="font-bold text-[18px]">ADD NEW BLOG</h2>
            </div>
            ...
            >
              ...
              <div className="flex items-center justify-center gap-3">
                <div className="name w-full">
                  <div className="name mb-2 border rounded-lg overflow-hidden">
                    <Editor
                      value={html}
                      disabled={isUploading}
